...
- **[Challenge mode](challenge.html).** A mobile-friendly mini-game: hand-control the reactor against an RL ghost racing the *same* disturbances, then see the economic gap for yourself.
