...
import { Engine, CATALOG } from './sim/engine.js?v=23';
import { buildSchematic } from './schematic.js?v=23';
import { buildCharts } from './charts.js?v=23';
import { buildControls } from './controls.js?v=23';
import { t, applyStatic, toggleLang, lang, onLang, nextLang } from './i18n.js?v=23';
