...
import { Engine, CATALOG } from './sim/engine.js?v=24';
import { buildSchematic } from './schematic.js?v=24';
import { buildCharts } from './charts.js?v=24';
import { buildControls } from './controls.js?v=24';
import { t, applyStatic, toggleLang, lang, onLang, nextLang } from './i18n.js?v=24';
